...
CREATE TABLE CM_PURPOSE (
  ...
  TENANT_ID     INTEGER DEFAULT '-1234',
  UNIQUE KEY (NAME, TENANT_ID, PURPOSE_GROUP, GROUP_TYPE, VERSION),
  PRIMARY KEY (ID)
);
...
INSERT INTO CM_PURPOSE (NAME, PURPOSE_ID, VERSION, DESCRIPTION, PURPOSE_GROUP, GROUP_TYPE, TENANT_ID) VALUES ('DEFAULT', '9400f5a0-914f-11e8-9eb6-529269fb1459', 1, 'For core functionalities of the product', 'DEFAULT', 'SP', '-1234');
